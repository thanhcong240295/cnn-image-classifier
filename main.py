...
from visualization import plot_training_history, plot_confusion_matrix, plot_prediction_distribution, plot_roc_curve, generate_report
from utils import validate_arguments, save_predictions_to_csv
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        try:
            ...
            plot_confusion_matrix(classifier.y_test, test_predictions, classifier.class_names, 
                                classifier.PREDICTION_THRESHOLD, 
                                save_path=os.path.join(result_dir, 'confusion_matrix.png'))
            plot_prediction_distribution(test_predictions, classifier.PREDICTION_THRESHOLD,
            ...
            generate_report(classifier.y_test, test_predictions, classifier.class_names, 
                          classifier.PREDICTION_THRESHOLD, classifier.USE_ROC_AUC)
        except:
            pass
